...
def main():
    ...
    def load_data():
        data = pd.read_csv('C:/Users/HP/Desktop/streamlit web app/Machine Learning Streamlit/mushrooms.csv')
        label = LabelEncoder()
    ...
    classifier = st.sidebar.selectbox("Calssifier",("Support Vector Machine(SVM)","Logistic Regression","Random forest"))
